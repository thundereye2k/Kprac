...
public class QueueManager extends Manager
{
    ...
    public void addToUnrankedQueue(final String kitName, final UUID uuid) {
        ...
        Bukkit.getScheduler().runTaskAsynchronously(this.handler.getPlugin(), new UpdateInventoryTask(this.handler.getPlugin(), UpdateInventoryTask.InventoryTaskType.UNRANKED_SOLO));
    }
    ...
    public void addToRankedQueue(final String kitName, final UUID uuid) {
        ...
        Bukkit.getScheduler().runTaskAsynchronously(this.handler.getPlugin(), new UpdateInventoryTask(this.handler.getPlugin(), UpdateInventoryTask.InventoryTaskType.RANKED_SOLO));
    }
    ...
    public void addToPremiumQueue(final String kitName, final UUID uuid) {
        ...
        Bukkit.getScheduler().runTaskAsynchronously(this.handler.getPlugin(), new UpdateInventoryTask(this.handler.getPlugin(), UpdateInventoryTask.InventoryTaskType.PREMIUM_SOLO));
    }
    ...
    public void unqueueSingleQueue(final UUID playerUuid) {
        ...
        for (final Map.Entry<String, List<UUID>> mapEntry2 : this.rankedKitQueueMap.entrySet()) {
            final String kitName = mapEntry2.getKey();
            final List<UUID> queuedUuidList = mapEntry2.getValue();
        ...
        for (final Map.Entry<String, List<UUID>> mapEntry2 : this.premiumKitQueueMap.entrySet()) {
            final String kitName = mapEntry2.getKey();
            final List<UUID> queuedUuidList = mapEntry2.getValue();
            if (!queuedUuidList.contains(playerUuid)) {
                continue;
    ...
    public void addToPartyRankedQueue(final String kitName, final UUID uuid) {
        ...
        ++this.rankedQueueCount;
        Bukkit.getScheduler().runTaskAsynchronously(this.handler.getPlugin(), new UpdateInventoryTask(this.handler.getPlugin(), UpdateInventoryTask.InventoryTaskType.RANKED_PARTY));
    }
    ...
    public void unqueuePartyQueue(final UUID leaderUuid) {
        ...
        for (final Map.Entry<String, List<UUID>> mapEntry2 : this.partyRankedKitQueueMap.entrySet()) {
            final String kitName = mapEntry2.getKey();
            final List<UUID> queuedUuidList = mapEntry2.getValue();
