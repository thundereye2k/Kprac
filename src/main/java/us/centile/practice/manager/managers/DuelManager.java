...
public class DuelManager extends Manager
{
    ...
    public DuelManager(final nPractice plugin, final ManagerHandler handler) {
        super(handler);
        this.plugin = plugin;
    ...
    public void removePlayerFromDuel(final Player player) {
        ...
        final PlayerBoard playerBoard = nPractice.getInstance().getManagerHandler().getScoreboardHandler().getPlayerBoard(player.getUniqueId());
